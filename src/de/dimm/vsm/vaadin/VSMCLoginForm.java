 ...
 * @since 5.3
 */
public class VSMCLoginForm extends CustomComponent
{

    private String username = "";
    private String usernameCaption = VSMCMain.Txt("Username");
    private String passwordCaption = VSMCMain.Txt("Password");
    private String loginButtonCaption = VSMCMain.Txt("Login");
    ...
    private ApplicationResource loginPage = new ApplicationResource() {
        ...
        public Application getApplication() {
            return VSMCLoginForm.this.getApplication();
        }
    ...
    private ParameterHandler paramHandler = new ParameterHandler() {
        ...
        public void handleParameters(Map<String, String[]> parameters) {
            if (parameters.containsKey("username")) {
                ...
                VSMCLoginEvent event = new VSMCLoginEvent(params);
                fireEvent(event);
            }
        }
    };
    ...
    protected byte[] getLoginHTML() {
        ...
        return ("<!DOCTYPE html PUBLIC \"-//W3C//DTD "
                ...
                + usernameCaption
                + "</div><div >"
                + "<input class='v-textfield' style='display:block;' type='text' name='username' value='" + username + "'></div>"
                + "<div>"
                + passwordCaption
                + "</div>"
     ...
     */
    public class VSMCLoginEvent extends Event {

        private Map<String, String> params;

        private VSMCLoginEvent(Map<String, String> params) {
            super(VSMCLoginForm.this);
            this.params = params;
        }
    ...
    public interface LoginListener extends Serializable {
         ...
         * @param event
         */
        public void onLogin(VSMCLoginForm.VSMCLoginEvent event);
    }
    ...
    static {
        try {
            ON_LOGIN_METHOD = LoginListener.class.getDeclaredMethod("onLogin",
                    new Class[] { VSMCLoginEvent.class });
    ...
    public void addListener(LoginListener listener) {
        addListener(VSMCLoginEvent.class, listener, ON_LOGIN_METHOD);
    }
    ...
    public void removeListener(LoginListener listener) {
        removeListener(VSMCLoginEvent.class, listener, ON_LOGIN_METHOD);
    }
