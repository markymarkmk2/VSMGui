 ...
 */
public class NewMountDlg {
     MountEntry mountEntry;
     VSMCMain main;
     ClickListener okClick;

    public NewMountDlg(VSMCMain main)
    {
        this.main = main;
    ...
    Window buildGui(StoragePool pool)
    {
        ...
        JPATextField jpaIp = new JPATextField(VSMCMain.Txt("Ziel-IP"), "ip");
        vl.addComponent(jpaIp.createGui(mountEntry));
        JPATextField jpaPort = new JPATextField(VSMCMain.Txt("Ziel-Port"), "port");
        vl.addComponent(jpaPort.createGui(mountEntry));
        ...
        vl.addComponent(subPath.createGui(mountEntry));
